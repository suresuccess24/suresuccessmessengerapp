...
```
npm create cloudflare@latest -- --template=cloudflare/templates/suresuccessmessengerapp
```

A live public deployment of this template is available at [https://suresuccessmessengerapp.templates.workers.dev](https://suresuccessmessengerapp.templates.workers.dev)
